...
class LiveValue {
  ...
  String? vnpayUrl;
  String? vnpayKey;
  String? vnpayPublickey;
  /// For Momo
  String? momoUrl;
  String? momoPartCode;
  String? momoAccressKey;
  ...
  factory LiveValue.fromJson(Map<String, dynamic> json) {
    return LiveValue(
      ...
      vnpayUrl: json['vnpay_url'] ?? '',
      vnpayKey: json['vnpay_key'] ?? '',
      vnpayPublickey: json['vnpay_publickey'] ?? '',
      momoUrl: json['momo_url'] ?? '',
      momoPartCode: json['momo_partnerCode'] ?? '',
      momoAccressKey: json['momo_accesskey'] ?? '',
      momoSecretKey: json['momo_secretKey'] ?? '',
  ...
  Map<String, dynamic> toJson() {
    ...
    data['stripe_publickey'] = this.stripePublickey;
     data['vnpay_url'] = this.vnpayUrl;
    data['vnpay_key'] = this.vnpayKey;
    data['vnpay_publickey'] = this.vnpayPublickey;
    data['momo_url'] = this.momoUrl;
    data['momo_partnerCode'] = this.momoPartCode;
    data['momo_accesskey'] = this.momoAccressKey;
    data['momo_secretKey'] = this.momoSecretKey;
